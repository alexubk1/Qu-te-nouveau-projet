...
class Flight
{
    ...
    {
        // Return the User object with "[fisrtName] - [lastName]]" FORMAT, when __toString is called.
     ...
     * Set flights.
     *
     * @param \AppBundle\Entity\Reservation|null $flights
     *
     * @return Flight
     */
    public function setFlights(\AppBundle\Entity\Reservation $flights = null)
    {
